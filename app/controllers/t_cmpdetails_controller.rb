class TCmpdetailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @t_cmpdetail.save
        format.html { redirect_to @t_cmpdetail, notice: 'Information was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @t_cmpdetail.update(t_cmpdetail_params)
        format.html { redirect_to @t_cmpdetail, notice: 'Information was successfully updated.' }
